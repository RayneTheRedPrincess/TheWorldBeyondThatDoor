...
class App {
  ...
  bootstrapAccount(account) {
    ...
    next.settings = { combatSpeed: 1, autoEndTurn: true, reducedMotion: false, combatNumbers: true, screenFlash: 'standard', ...(next.settings || {}) };
